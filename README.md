...
![GitHub Workflow Status](https://github.com/defund-labs/relayer/actions/workflows/build.yml/badge.svg)
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue?style=flat-square&logo=go)](https://godoc.org/github.com/defund-labs/relayer)
[![Go Report Card](https://goreportcard.com/badge/github.com/defund-labs/relayer)](https://goreportcard.com/report/github.com/defund-labs/relayer)
[![License: Apache-2.0](https://img.shields.io/github/license/defund-labs/relayer.svg?style=flat-square)](https://github.com/defund-labs/relayer/blob/main/LICENSE)
[![Lines Of Code](https://img.shields.io/tokei/lines/github/defund-labs/relayer?style=flat-square)](https://github.com/defund-labs/relayer)
[![Version](https://img.shields.io/github/tag/defund-labs/relayer.svg?style=flat-square)](https://github.com/defund-labs/relayer/latest)
</div>
...
1. **Clone, checkout and install the latest release ([releases page](https://github.com/defund-labs/relayer/releases)).**

   *[Go](https://go.dev/doc/install) needs to be installed and a proper Go environment needs to be configured*

    ```shell
    $ git clone https://github.com/defund-labs/relayer.git
    $ git checkout v2.0.0
...
3. **Configure the chains you want to relay between.**
   ...
   To add the chain config files manually, example config files have been included [here](https://github.com/defund-labs/relayer/tree/main/docs/example-configs/)
   ```shell
   $ rly chains add --url https://raw.githubusercontent.com/defund-labs/relayer/main/docs/example-configs/cosmoshub-4.json cosmoshub
   $ rly chains add --url https://raw.githubusercontent.com/defund-labs/relayer/main/docs/example-configs/osmosis-1.json osmosis
   ```
...
7. **Configure path meta-data in config file.**
   ...
   The path meta-data is queried from the [interchain](https://github.com/defund-labs/relayer/tree/main/interchain) directory.
